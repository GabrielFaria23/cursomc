package com.gabrielfaria.cursomc.resources.exception;
...
import com.gabrielfaria.cursomc.services.exception.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request){
		...
		HttpStatus code = HttpStatus.valueOf(e.getErrorCode()); // pega o codigo do erro vindo do AmazonServiceException
