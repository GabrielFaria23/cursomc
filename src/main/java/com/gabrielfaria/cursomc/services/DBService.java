...
import com.gabrielfaria.cursomc.domain.ItemPedido;
import com.gabrielfaria.cursomc.domain.Pagamento;
...
import com.gabrielfaria.cursomc.repositories.EnderecoRepository;
import com.gabrielfaria.cursomc.repositories.EstadoRepository;
import com.gabrielfaria.cursomc.repositories.ItemPedidoRepository;
import com.gabrielfaria.cursomc.repositories.PagamentoRepository;
import com.gabrielfaria.cursomc.repositories.PedidoRepository;
import com.gabrielfaria.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "gabrielfariapta01@gmail.com", "36378912377",  TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "gabrielfariapta02@gmail.com", "37327885390",  TipoCliente.PESSOAFISICA, pe.encode("123"));		
		cli1.getTelefones().addAll(Arrays.asList("992555435", "998866475"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300" , "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105" , "Sala 800", "Centro ", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106" , null, "Centro ", "28577012", cli2, c2);
